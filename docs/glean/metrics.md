...
| --- | --- | --- | --- | --- | --- | --- |
| legacy.ids.client_id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The client id from legacy telemetry.  |[mozilla-mobile/firefox-tv#2992](https://github.com/mozilla-mobile/firefox-tv/pull/2992)||never | |
